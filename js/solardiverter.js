...
(function () {
    ...
    var translations = {
        pt: {
            ...
            step4_desc: 'Ligue-se à rede WiFi <strong>“SolarDiverter-Setup”</strong> (sem password) e abra <strong>192.168.4.1</strong>. Configure a rede doméstica, medidor e potência nominal. Insira a chave de ativação recebida por email para desbloquear o firmware.',
        ...
        en: {
            ...
            step4_desc: 'Connect to the <strong>“SolarDiverter-Setup”</strong> WiFi (no password) and open <strong>192.168.4.1</strong>. Set up your home network, energy meter and nominal power. Enter the activation key received by email to unlock the firmware.',
        ...
        fr: {
            ...
            step4_desc: 'Connectez-vous au WiFi <strong>“SolarDiverter-Setup”</strong> (sans mot de passe) et ouvrez <strong>192.168.4.1</strong>. Configurez le réseau, le compteur et la puissance nominale. Entrez la clé d\'activation reçue par email.',
        ...
        es: {
            ...
            step4_desc: 'Conéctese al WiFi <strong>“SolarDiverter-Setup”</strong> (sin contraseña) y abra <strong>192.168.4.1</strong>. Configure la red, el medidor y la potencia nominal. Introduzca la clave de activación recibida por email.',
            tip_reset_title: 'Reset de Fábrica:',
