...
(function () {
    ...
    var translations = {
        pt: {
            ...
            step1_desc: 'Extraia o ZIP, ligue o ESP32 via USB e execute o <code>flash.bat</code> (Windows) incluído no pacote. O script usa o <code>esptool.exe</code> para gravar firmware + SPIFFS automaticamente.',
        ...
        en: {
            ...
            step1_desc: 'Extract the ZIP, connect the ESP32 via USB and run <code>flash.bat</code> (Windows) included in the package. The script uses <code>esptool.exe</code> to flash firmware + SPIFFS automatically.',
        ...
        fr: {
            ...
            step1_desc: 'Extrayez le ZIP, connectez l\'ESP32 via USB et exécutez <code>flash.bat</code> (Windows) inclus dans le package. Le script utilise <code>esptool.exe</code> pour flasher firmware + SPIFFS automatiquement.',
        ...
        es: {
            ...
            step1_desc: 'Extraiga el ZIP, conecte el ESP32 via USB y ejecute <code>flash.bat</code> (Windows) incluido en el paquete. El script usa <code>esptool.exe</code> para grabar firmware + SPIFFS automáticamente.',
